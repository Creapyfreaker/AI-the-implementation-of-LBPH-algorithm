...
gray = cv2.imread('F:/Python/b.jpg', cv2.IMREAD_GRAYSCALE)
cv2.imshow('img', gray)
circul_1_8 = circular_LBP(gray,1,8)
circul_3_8 = circular_LBP(gray,3,8)
circul_3_6 = circular_LBP(gray,3,6)

cv2.namedWindow('18',cv2.WINDOW_NORMAL)
cv2.imshow('18', circul_1_8)

cv2.namedWindow('38',cv2.WINDOW_NORMAL)
cv2.imshow('38', circul_3_8)

cv2.namedWindow('36',cv2.WINDOW_NORMAL)
